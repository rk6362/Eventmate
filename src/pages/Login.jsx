    ...
    const handleSubmit = (e) => {
        ...
        if (formData.email && formData.password) {
            ...
            login({
                ...
                name: formData.email.split('@')[0], // Dummy name extraction
            });
            navigate('/home');
        }
    };
    ...
    return (
        <div className="page-wrapper auth-page">
            <div className="auth-header">
                <h2>Welcome Back</h2>
                <p className="subtitle">Login to access your personalized events</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="glass-panel auth-form">
                ...
                <div style={{ textAlign: 'center', marginTop: '1.5rem' }}>
                    <Link to="#" className="link-text" style={{ fontSize: '0.9rem' }}>Forgot Password?</Link>
                </div>
